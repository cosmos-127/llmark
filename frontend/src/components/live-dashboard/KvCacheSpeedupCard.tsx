    ...
    <Card className="rounded-2xl border border-emerald-500/25 dark:border-emerald-500/30 shadow-xs bg-emerald-50/40 dark:bg-emerald-950/15 overflow-hidden">
      <CardHeader className="p-4 pb-2 border-b border-emerald-500/10">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle className="text-sm font-semibold font-sans text-[#2C2C2C] dark:text-white flex items-center gap-2">
              ...
              <CardDescription className="text-[11px] text-[#2C2C2C]/70 dark:text-slate-300">
          ...
          <div className="flex items-center gap-1.5 text-xs">
            <span className="text-[11px] text-[#2C2C2C]/60 dark:text-slate-400 font-medium">Cache Hit Rate:</span>
      ...
      <CardContent className="p-4 space-y-3 font-sans">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {/* Cold Baseline */}
          <div className="p-3 rounded-xl bg-white dark:bg-[#121217] border border-[#2C2C2C]/10 dark:border-white/10 space-y-1">
            <div className="flex items-center justify-between text-xs">
              <span className="text-[#2C2C2C]/60 dark:text-slate-400 font-medium flex items-center gap-1">
            ...
            <p className="text-xl font-bold tabular-nums text-[#2C2C2C] dark:text-white">
              {coldTtft.toFixed(0)} <span className="text-xs font-normal text-[#2C2C2C]/60 dark:text-slate-400">ms</span>
            </p>
            <p className="text-[10px] text-[#2C2C2C]/50 dark:text-slate-400">
              Uncached prompt prefill compute across all layers
            </p>
          </div>

          {/* Warm Cached */}
          <div className="p-3 rounded-xl bg-white dark:bg-[#121217] border border-emerald-500/20 dark:border-emerald-500/25 space-y-1">
            <div className="flex items-center justify-between text-xs">
            ...
            <p className="text-xl font-bold tabular-nums text-emerald-600 dark:text-emerald-400">
              {warmTtft.toFixed(0)} <span className="text-xs font-normal text-[#2C2C2C]/60 dark:text-slate-400">ms</span>
            </p>
            <p className="text-[10px] text-[#2C2C2C]/50 dark:text-slate-400">
        ...
        <div className="space-y-1.5 p-3 rounded-xl bg-white dark:bg-[#121217] border border-[#2C2C2C]/10 dark:border-white/10 text-xs">
          <div className="flex items-center justify-between text-[11px]">
            <span className="text-[#2C2C2C]/70 dark:text-slate-300 font-medium">Latency Reduction:</span>
            <span className="font-semibold text-emerald-700 dark:text-emerald-400 tabular-nums">
              -{Math.max(0, coldTtft - warmTtft).toFixed(0)} ms saved per request
            </span>
          </div>

          <div className="h-2.5 w-full rounded-full bg-[#F3F4F4] dark:bg-[#1E1E26] overflow-hidden relative">
            <div
          ...
          <div className="flex items-center justify-between text-[10px] text-[#2C2C2C]/50 dark:text-slate-400 pt-0.5">
        ...
        <div className="flex items-center justify-between text-xs px-1 text-[#2C2C2C]/70 dark:text-slate-300">
          ...
          <span className="text-[11px] text-[#2C2C2C]/50 dark:text-slate-400">
