...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm font-sans text-left", className)}
      {...props}
    />
  </div>
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-9 px-4 text-left align-middle font-sans font-semibold text-[#2C2C2C]/70 dark:text-[#F3F4F4]/70 text-[11px] tracking-wider uppercase [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
