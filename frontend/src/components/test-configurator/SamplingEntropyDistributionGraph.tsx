...
export const SamplingEntropyDistributionGraph: React.FC<SamplingEntropyDistributionGraphProps> = ({
  ...
  return (
    <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-5 sm:p-6 space-y-5 shadow-xs">
      ...
      <div className="relative rounded-2xl bg-[var(--bg-surface-subtle)]/70 dark:bg-[var(--bg-surface-elevated)] border border-[var(--border-subtle)] p-4 pt-5 space-y-3 select-none">
        {/* Token Bars */}
            ...
            return (
              ...
              >
                ...
                <span className={`text-[10px] font-sans tabular-nums font-bold mb-1.5 transition-all ${
                  isTop ? "text-[var(--brand-primary)]" : "text-[var(--text-muted)] dark:text-white/65"
                }`}>
                ...
                <motion.div
                  ...
                  className={`w-full rounded-t-lg transition-all ${
                    isTop
                      ? "bg-gradient-to-t from-[var(--brand-primary)] to-[var(--brand-secondary)] shadow-xs"
                      : isHovered
                      ? "bg-[var(--brand-secondary)] shadow-sm"
                      : "bg-[var(--brand-primary-light)] group-hover:bg-[var(--brand-primary-light)]"
                  }`}
                />

                {/* Token Identifier Label below bar */}
                <span className="text-[11px] font-sans font-medium text-[var(--text-muted)] mt-1.5 truncate max-w-full text-center">
                  w{idx + 1}
                </span>
              </div>
            );
          ...
          {hoveredToken && (
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[var(--brand-primary)] font-sans font-bold text-sm">P = {hoveredToken.probPct}%</span>
              </div>
      ...
      <div className="space-y-2 p-4 rounded-2xl bg-[var(--bg-surface-subtle)]/70 dark:bg-[var(--bg-surface-elevated)] border border-[var(--border-subtle)] text-xs">
        <div className="flex items-center justify-between text-xs">
          <span className="text-[var(--text-body)] font-medium flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
        <div className="p-3 rounded-xl bg-[var(--bg-surface-subtle)] border border-[var(--border-subtle)] space-y-1">
          ...
          <div className="font-semibold text-[var(--brand-primary)] text-xs truncate">
        ...
        <div className="p-3 rounded-xl bg-[var(--bg-surface-subtle)] border border-[var(--border-subtle)] space-y-1">
          <span className="text-[11px] text-[var(--text-main)]/55 dark:text-white/55 font-medium flex items-center gap-1.5">
            <Activity className="h-3.5 w-3.5 text-[var(--brand-secondary)]" />
            Top-1 Token Confidence
          </span>
          <div className="font-sans tabular-nums font-bold text-[var(--text-main)] text-xs">
