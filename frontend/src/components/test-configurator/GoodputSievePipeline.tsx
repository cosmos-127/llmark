    ...
    <div className="rounded-2xl border border-[#0F172A]/10 dark:border-white/10 bg-white dark:bg-[#111827] p-5 sm:p-6 space-y-5 shadow-xs">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-xl border bg-[#2563EB]/10 dark:bg-[#3B82F6]/15 border-[#2563EB]/25 dark:border-[#3B82F6]/35 text-[#2563EB] dark:text-[#60A5FA] shadow-2xs">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Badge variant="outline" className="text-[10px] font-sans py-0 px-2 text-[#2563EB] dark:text-[#60A5FA] border-[#2563EB]/30 dark:border-[#3B82F6]/40">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 items-center p-4 sm:p-5 rounded-2xl bg-[#F1F5F9]/70 dark:bg-[#1E293B] border border-[#0F172A]/10 select-none">
        {/* Gate 1: TTFT Sieve */}
        <div className="p-4 rounded-xl bg-white dark:bg-[#111827] border border-[#0F172A]/10 space-y-2 relative shadow-xs">
          <div className="flex items-center justify-between text-xs">
            ...
            <span className="font-sans font-bold text-sm text-[#2563EB] dark:text-[#60A5FA]">
              {ttftPassPct}%
            </span>
          </div>
          <p className="text-xs text-[#0F172A]/65 dark:text-white/65">
            Filters TTFT ≤ {maxTtftMs}ms. Eliminates cold-start queue spikes.
          </p>
          <div className="h-2 w-full rounded-full bg-[#F1F5F9] dark:bg-[#1E293B] overflow-hidden">
            <motion.div
              className="h-full bg-[#2563EB] dark:bg-[#3B82F6]"
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#111827] border border-[#0F172A]/10 space-y-2 shadow-xs">
          <div className="flex items-center justify-between text-xs">
            <span className="font-semibold text-[#1D4ED8] dark:text-[#38BDF8] flex items-center gap-1.5">
              <Zap className="h-4 w-4" /> Gate 2: TPOT
            </span>
            <span className="font-sans font-bold text-sm text-[#1D4ED8] dark:text-[#38BDF8]">
              {tpotPassPct}%
            </span>
          </div>
          <p className="text-xs text-[#0F172A]/65 dark:text-white/65">
          ...
          <div className="h-2 w-full rounded-full bg-[#F1F5F9] dark:bg-[#1E293B] overflow-hidden">
            <motion.div
              className="h-full bg-[#1D4ED8] dark:bg-[#60A5FA]"
