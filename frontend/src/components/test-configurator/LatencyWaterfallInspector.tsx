    ...
    <div className="rounded-2xl border border-[#2C2C2C]/10 dark:border-[#F3F4F4]/10 bg-white dark:bg-[#252426] p-5 sm:p-6 space-y-5 shadow-xs">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="text-right flex flex-col items-end">
          <span className="text-base font-extrabold font-sans tabular-nums text-[#853953] dark:text-[#A74B6A]">
            {ttftMs}ms TTFT
          </span>
      ...
      <div className="space-y-2 p-4 sm:p-5 rounded-2xl bg-[#F3F4F4]/70 dark:bg-[#1E1D1F] border border-[#2C2C2C]/10 select-none">
        <div className="h-7 w-full rounded-xl bg-white dark:bg-[#252426] border border-[#2C2C2C]/10 p-0.5 flex items-center overflow-hidden gap-1 shadow-inner">
          {phases.map((phase) => (
            <motion.div
              key={phase.id}
              initial={{ width: 0 }}
        ...
        <AnimatePresence>
          {hoveredPhase ? (
            ...
            <div className="flex items-center justify-between text-xs font-sans text-[#2C2C2C]/70 dark:text-[#F3F4F4]/70 pt-1">
              ...
              <span className="font-bold text-[#853953] dark:text-[#A74B6A]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
        ...
        <div className="p-3 rounded-xl bg-[#F3F4F4]/80 dark:bg-[#2C2C2C]/50 border border-[#2C2C2C]/10 space-y-1">
          <span className="text-[11px] text-[#2C2C2C]/55 dark:text-[#F3F4F4]/55 font-medium flex items-center gap-1.5">
            <Zap className="h-3.5 w-3.5 text-[#612D53] dark:text-[#C57BB2]" />
