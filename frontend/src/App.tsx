    ...
    <ThemeProvider>
      <QueryClientProvider client={queryClient}>
        <TooltipProvider delayDuration={200}>
          <div className="min-h-screen bg-[#F3F4F4] dark:bg-[#08080A] text-[#2C2C2C] dark:text-white flex flex-col font-sans relative overflow-x-clip transition-colors duration-200">
              ...
              <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
                <div className="flex items-center gap-2.5">
                  <button
                    ...
                    className="flex items-center gap-2 font-semibold text-[#2C2C2C] dark:text-white hover:text-[#853953] dark:hover:text-[#F06A9A] cursor-pointer transition-colors group"
                  >
                    <LLMarkLogo className="h-4.5 w-4.5" />
                    <span>LLMark</span>
                  </button>
                  <span className="text-[#2C2C2C]/30 dark:text-white/20">•</span>
                  <span className="font-normal text-[#2C2C2C]/70 dark:text-slate-400">
