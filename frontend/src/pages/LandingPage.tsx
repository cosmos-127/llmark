  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-2xl transition-all duration-200 ${
        isHovered
          ? "shadow-lg shadow-[#853953]/5 dark:shadow-[#E05284]/15 border-[#853953]/40 dark:border-[#E05284]/50"
...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative flex-1 w-full flex flex-col justify-between selection:bg-[#853953]/20 selection:text-[#853953] dark:selection:bg-[#E05284]/30 dark:selection:text-[#F06A9A]"
    >
      {/* Precision Scroll Progress Line */}
      <div className="gsap-scroll-progress fixed top-0 left-0 right-0 h-[2.5px] bg-gradient-to-r from-[#853953] via-[#E05284] to-[#853953] z-50 origin-left scale-x-0 pointer-events-none opacity-90 shadow-sm" />

      {/* Main Spacious Landing Canvas */}
      <main className="flex-1 w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 space-y-24 sm:space-y-32 lg:space-y-36">
        {/* ===================================================================
            SECTION 1: HERO (Centred, Breathable, Minimal)
            =================================================================== */}
        <section id="hero-section" className="text-center max-w-4xl mx-auto pt-4 sm:pt-8">
          <div id="hero-content" className="space-y-8">
            <div className="space-y-5">
              {/* Minimal Micro-Badge */}
              <div className="gsap-hero-badge inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#853953]/10 dark:bg-[#E05284]/15 border border-[#853953]/25 dark:border-[#E05284]/35 text-[#853953] dark:text-[#F06A9A] text-xs font-mono font-medium shadow-xs tracking-wide">
                <span className="h-1.5 w-1.5 rounded-full bg-[#853953] dark:bg-[#E05284] animate-pulse" />
                <span>LIVE INFERENCE BENCHMARKING</span>
              </div>

              {/* Main Headline */}
              <h1 className="gsap-hero-title text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-[#2C2C2C] dark:text-white font-sans leading-[1.12]">
                Precision Load Testing & <span className="text-gradient-brand">Inference Telemetry</span>
              </h1>

              {/* Sub-headline Description */}
              <p className="gsap-hero-desc text-base sm:text-lg text-[#2C2C2C]/70 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-1">
              <Button
                ...
                className="gsap-hero-btn btn-brand-glow text-white shadow-lg shadow-[#853953]/25 dark:shadow-[#D84577]/30 h-12 px-7 rounded-xl text-sm font-semibold flex items-center gap-2.5 cursor-pointer group"
              >
              ...
              <Button
                ...
                className="gsap-hero-btn h-12 px-6 rounded-xl text-sm font-semibold bg-white/80 dark:bg-[#0F0F13]/90 border-[#2C2C2C]/15 dark:border-white/10 hover:border-[#853953]/40 dark:hover:border-[#E05284]/40 text-[#2C2C2C] dark:text-white flex items-center gap-2 cursor-pointer transition-all shadow-xs"
              >
                <Icons.Diff className="h-4 w-4 text-[#853953] dark:text-[#F06A9A]" />
        ...
        <section id="telemetry-section" className="space-y-6">
          ...
          <div className="gsap-telemetry-header text-center max-w-2xl mx-auto space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#853953]/10 dark:bg-[#E05284]/15 text-[#853953] dark:text-[#F06A9A] text-[11px] font-semibold uppercase tracking-wider font-mono">
              01 // LIVE SANDBOX
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#2C2C2C] dark:text-white">
              Instant Telemetry Probe
            </h2>
            <p className="text-sm text-[#2C2C2C]/65 dark:text-slate-400">
          ...
          <div className="gsap-telemetry-card-wrap">
            <SpotlightCard
              ...
              className="bg-white/95 dark:bg-[#0F0F13]/95 border border-[#2C2C2C]/10 dark:border-white/[0.08] p-6 sm:p-8 group shadow-sm space-y-6"
            >
              {/* Card Header with Title, Live Status, Model Selector & Instant Probe Action */}
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-5 border-b border-[#2C2C2C]/8 dark:border-white/[0.06]">
                {/* Left: Title, Live Status & Active Model Tagline */}
                <div className="flex items-center gap-3.5">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#853953]/10 dark:bg-[#E05284]/15 text-[#853953] dark:text-[#F06A9A] shrink-0">
                    <Icons.Activity className="h-6 w-6" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2.5">
                      <span className="text-base font-semibold text-[#2C2C2C] dark:text-white font-sans">
                        Instant Telemetry Probe
                      </span>
                    ...
                    <span className="text-xs text-[#2C2C2C]/50 dark:text-slate-400 font-sans">
                ...
                <div className="flex items-center gap-2.5 flex-nowrap shrink-0 overflow-x-auto py-0.5">
                  {/* Model Selector Tabs */}
                  <div className="flex items-center gap-1 p-1 rounded-xl bg-[#F3F4F4] dark:bg-[#08080A] border border-[#2C2C2C]/8 dark:border-white/[0.06] shrink-0">
                    {PROBE_MODELS.map((m) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2.5 py-1 rounded-lg text-xs font-medium transition-all cursor-pointer flex items-center gap-1.5 select-none shrink-0 ${
                            isSelected
                              ? "bg-white dark:bg-[#1A1A24] text-[#853953] dark:text-[#F06A9A] font-semibold shadow-2xs border border-[#853953]/25 dark:border-[#E05284]/35"
                              : "text-[#2C2C2C]/65 dark:text-slate-400 hover:text-[#2C2C2C] dark:hover:text-white"
                  ...
                  <Button
                    ...
                    className={`h-9 px-3.5 sm:px-4 rounded-xl text-xs font-semibold flex items-center gap-2 cursor-pointer shrink-0 transition-all shadow-xs whitespace-nowrap ${
                      probeState === "probing"
                        ...
                        : "btn-brand-glow text-white shadow-md shadow-[#853953]/25 dark:shadow-[#D84577]/30 hover:scale-[1.02]"
                    }`}
                  >
                    {probeState === "probing" ? (
                      <>
              ...
              <div className="rounded-xl bg-[#F3F4F4]/70 dark:bg-[#08080A]/80 border border-[#2C2C2C]/8 dark:border-white/[0.06] p-3 space-y-2">
                <div className="flex items-center justify-between text-xs font-sans">
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-[#2C2C2C] dark:text-white font-sans text-xs">
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1.5 rounded-lg text-xs font-mono font-medium text-left flex flex-col justify-between border transition-all cursor-pointer ${
                      selectedInspectPacket === null
                        ? "bg-white dark:bg-[#1A1A24] border-[#853953] dark:border-[#E05284] text-[#853953] dark:text-[#F06A9A] shadow-xs"
                        : "bg-white/40 dark:bg-[#0F0F13]/40 border-[#2C2C2C]/8 dark:border-white/5 text-[#2C2C2C]/70 dark:text-slate-400 hover:border-[#2C2C2C]/20 dark:hover:border-white/15"
                    }`}
                  >
                    <span className="text-[10px] uppercase tracking-wider text-[#2C2C2C]/50 dark:text-slate-400 font-sans font-semibold">
                      Composite
                    </span>
                    ...
                    return (
                      <button
                        ...
                        className={`px-2.5 py-1.5 rounded-lg text-xs font-mono text-left flex flex-col justify-between border transition-all ${
                          isSelected
                            ? "bg-white dark:bg-[#1A1A24] border-[#853953] dark:border-[#E05284] text-[#853953] dark:text-[#F06A9A] shadow-xs cursor-pointer"
                            : isRunning
                            ? "bg-amber-500/10 dark:bg-amber-500/15 border-amber-500/40 text-amber-700 dark:text-amber-300 animate-pulse"
                            : isCompleted
                            ? "bg-white/60 dark:bg-[#0F0F13]/60 border-emerald-500/20 text-[#2C2C2C] dark:text-slate-200 hover:border-emerald-500/40 cursor-pointer"
                            : "bg-white/20 dark:bg-[#0F0F13]/20 border-transparent text-[#2C2C2C]/40 dark:text-slate-600 opacity-60 cursor-not-allowed"
                        }`}
                      >
                        <div className="flex items-center justify-between">
                          ...
                          {isRunning ? (
                            ...
                            <span className="text-[10px] text-[#2C2C2C]/40 dark:text-slate-600">--</span>
                          )}
                        </div>
              ...
              <div className="gsap-waterfall-container space-y-3">
                <div className="flex items-center justify-between text-xs font-sans">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold text-[#2C2C2C]/80 dark:text-slate-200">
                  ...
                  <span className="text-xs font-mono text-[#853953] dark:text-[#F06A9A] font-bold tabular-nums">
                    Total Latency: <NumberTicker value={currentTotal} decimalPlaces={1} className="text-[#853953] dark:text-[#F06A9A]" />ms
                  </span>
                </div>

                {/* Segmented Timeline Bar with dynamic active glow & stage scale */}
                <div className="h-4 w-full rounded-full bg-[#F3F4F4] dark:bg-[#08080A] overflow-hidden flex shadow-inner p-0.5 border border-[#2C2C2C]/5 dark:border-white/5">
                  <div
                  ...
                  <div
                    ...
                    className={`gsap-waterfall-ttft origin-left bg-[#853953] dark:bg-[#E05284] transition-all duration-300 ${
                      probePhase === "ttft" ? "ring-2 ring-[#853953] dark:ring-[#F06A9A] brightness-125 animate-pulse z-10" : "opacity-90 hover:opacity-100"
                    }`}
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 text-xs font-mono text-[#2C2C2C]/65 dark:text-slate-400 pt-0.5">
                  ...
                  <div className={`gsap-waterfall-label flex items-center gap-1.5 font-semibold text-[#853953] dark:text-[#F06A9A] transition-colors ${probePhase === "ttft" ? "scale-105 font-bold" : ""}`}>
                    <span className="h-2 w-2 rounded-full bg-[#853953] dark:bg-[#D84577]" />
                    <span>TTFT (Prefill): <NumberTicker value={currentTtft} decimalPlaces={1} className="text-[#853953] dark:text-[#F06A9A]" />ms</span>
                  </div>
              ...
              <div className="rounded-xl bg-[#F3F4F4]/70 dark:bg-[#08080A]/90 border border-[#2C2C2C]/8 dark:border-white/[0.06] p-3 font-mono text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 transition-all">
                <div className="flex items-center gap-2 overflow-hidden flex-1">
                  ...
                  <div className="truncate text-[#2C2C2C]/80 dark:text-slate-300">
                    {(inspectedPacket ? inspectedPacket.tokens : probeTokens).length > 0 ? (
                      ...
                      <span className="text-[#2C2C2C]/50 dark:text-slate-500">
                        Click "Instant Probe (5-Packet Ping)" to execute live telemetry test...
                      </span>
                    )}
                    {probeState === "probing" && (
                      <span className="inline-block w-1.5 h-3.5 ml-1 bg-[#853953] dark:bg-[#E05284] animate-pulse align-middle" />
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 shrink-0 self-end sm:self-auto">
                  {probeState === "completed" && (
                    <button
                      ...
                      className="text-[11px] px-2 py-0.5 rounded-lg bg-white/80 dark:bg-[#1A1A24] border border-[#2C2C2C]/10 dark:border-white/10 hover:border-[#853953]/30 text-[#2C2C2C]/70 dark:text-slate-300 flex items-center gap-1 cursor-pointer transition-all"
                  ...
                  <span className="text-[11px] text-[#2C2C2C]/40 dark:text-slate-500 font-mono">
                    {activeProbeModel.id}
                  </span>
                </div>
              </div>
              ...
              <div className="gsap-metric-chips-grid grid grid-cols-2 sm:grid-cols-4 gap-4 pt-1">
                <div className={`gsap-metric-chip p-4 rounded-xl transition-all duration-300 bg-[#F3F4F4]/80 dark:bg-[#08080A]/80 border ${
                  probeState === "completed" ? "border-emerald-500/30 shadow-2xs shadow-emerald-500/5" : "border-[#2C2C2C]/5 dark:border-white/5"
                } space-y-1`}>
                  <div className="text-xs text-[#2C2C2C]/60 dark:text-slate-400 font-sans">TTFT (P95 Tail)</div>
                  <div className="text-xl font-bold text-[#2C2C2C] dark:text-white tabular-nums">
                    <NumberTicker value={activeProbeModel.ttft} decimalPlaces={1} className="text-xl font-bold text-[#2C2C2C] dark:text-white" /> <span className="text-xs font-normal text-[#2C2C2C]/50 dark:text-slate-400">ms</span>
                  </div>
                ...
                <div className={`gsap-metric-chip p-4 rounded-xl transition-all duration-300 bg-[#F3F4F4]/80 dark:bg-[#08080A]/80 border ${
                  ...
                  <div className="text-xs text-[#2C2C2C]/60 dark:text-slate-400 font-sans">ITL Tail (P99)</div>
                  <div className="text-xl font-bold text-[#2C2C2C] dark:text-white tabular-nums">
                    <NumberTicker value={activeProbeModel.itlTail} decimalPlaces={1} className="text-xl font-bold text-[#2C2C2C] dark:text-white" /> <span className="text-xs font-normal text-[#2C2C2C]/50 dark:text-slate-400">ms</span>
                  </div>
                ...
                <div className={`gsap-metric-chip p-4 rounded-xl transition-all duration-300 bg-[#F3F4F4]/80 dark:bg-[#08080A]/80 border ${
                  ...
                  <div className="text-xs text-[#2C2C2C]/60 dark:text-slate-400 font-sans">Goodput SLO</div>
                  ...
                  <div className="text-[11px] text-[#2C2C2C]/50 dark:text-slate-400 font-medium">Target: &gt;95.0%</div>
                </div>

                <div className={`gsap-metric-chip p-4 rounded-xl transition-all duration-300 bg-[#F3F4F4]/80 dark:bg-[#08080A]/80 border ${
                  probeState === "completed" ? "border-emerald-500/30 shadow-2xs shadow-emerald-500/5" : "border-[#2C2C2C]/5 dark:border-white/5"
                } space-y-1`}>
                  <div className="text-xs text-[#2C2C2C]/60 dark:text-slate-400 font-sans">Spend Guard</div>
                  <div className="text-xl font-bold text-[#853953] dark:text-[#F06A9A] tabular-nums">
                    $<NumberTicker value={activeProbeModel.spend * 5} decimalPlaces={6} className="text-xl font-bold text-[#853953] dark:text-[#F06A9A]" />
                  </div>
                  <div className="text-[11px] text-[#2C2C2C]/50 dark:text-slate-400 font-medium">Hard Cap: $1.00</div>
                </div>
              </div>

              {/* Zero-Setup Conversion Action Row */}
              <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-[#2C2C2C]/8 dark:border-white/[0.06]">
                <div className="flex items-center gap-2 text-xs text-[#2C2C2C]/60 dark:text-slate-400 font-sans">
                ...
                <div className="flex items-center gap-2.5">
                  <Button
                    ...
                    className="h-9 px-3.5 rounded-xl text-xs font-semibold bg-white/80 dark:bg-[#1A1A24] border-[#2C2C2C]/15 dark:border-white/10 hover:border-[#853953]/35 dark:hover:border-[#E05284]/40 text-[#2C2C2C] dark:text-white flex items-center gap-1.5 cursor-pointer transition-all"
                  >
                    <Icons.Diff className="h-3.5 w-3.5 text-[#853953] dark:text-[#F06A9A]" />
                    <span>Compare Models</span>
                  </Button>
              ...
              return (
                <div key={op.id} className="gsap-capability-card-wrap flex flex-col h-full">
                  <SpotlightCard
                    ...
                    className="bg-white/90 dark:bg-[#0F0F13]/90 border border-[#2C2C2C]/10 dark:border-white/[0.08] hover:border-[#853953]/35 dark:hover:border-[#E05284]/40 flex-1 flex flex-col justify-between p-6 sm:p-7 relative group transition-colors"
                  >
                    <div className="space-y-4">
                      {/* Header: Icon + Badge */}
                      <div className="flex items-start justify-between">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#853953]/10 dark:bg-[#E05284]/15 text-[#853953] dark:text-[#F06A9A] shadow-2xs group-hover:scale-105 transition-transform">
                          <Icon className="h-5 w-5" />
                        </div>
                        <Badge variant={op.badgeVariant} className="text-[10px] px-2 py-0.5 font-medium border-[#853953]/25 dark:border-[#E05284]/35 text-[#853953] dark:text-[#F06A9A] bg-[#853953]/5 dark:bg-[#E05284]/10">
                          {op.badgeText}
                        </Badge>
                      </div>
                      ...
                      {/* Description */}
                      <p className="text-xs text-[#2C2C2C]/70 dark:text-slate-400 leading-relaxed">
                        {op.description}
                      </p>

                      {/* Feature bullet list */}
                      <div className="space-y-2 pt-2 border-t border-[#2C2C2C]/8 dark:border-white/[0.06]">
                        {op.features.map((f, i) => (
                    ...
                    <div className="pt-5">
                      <Button
                        ...
                        className="w-full h-10 rounded-xl text-xs font-semibold flex items-center justify-center gap-2 cursor-pointer transition-all btn-brand-glow text-white shadow-md shadow-[#853953]/20"
                      >
            ...
            {providers.map((pr, i) => (
              <div key={i} className="gsap-provider-card-wrap">
                <motion.div
                  ...
                  className="p-3.5 rounded-xl bg-white/80 dark:bg-[#0F0F13]/90 border border-[#2C2C2C]/8 dark:border-white/[0.08] hover:border-[#853953]/35 dark:hover:border-[#E05284]/45 text-center cursor-default transition-all flex flex-col items-center justify-between gap-2 shadow-2xs group h-full"
                >
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-[#2C2C2C]/50 dark:text-slate-400 truncate font-sans">
                      {pr.sub}
                    </div>
                  </div>
                </motion.div>
        ...
        <section id="cta-section" className="pb-4">
          <div className="gsap-cta-card-wrap">
            <SpotlightCard
              ...
              className="bg-gradient-to-br from-white/95 via-white/90 to-[#853953]/5 dark:from-[#0F0F13]/95 dark:via-[#0F0F13]/90 dark:to-[#853953]/15 border border-[#853953]/25 dark:border-[#E05284]/35 p-8 sm:p-10 text-center space-y-5 group shadow-md"
            >
              <div className="max-w-2xl mx-auto space-y-2.5">
                <h3 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#2C2C2C] dark:text-white">
                  Ready to Benchmark Your Models?
                </h3>
                <p className="text-sm text-[#2C2C2C]/70 dark:text-slate-300">
              ...
              <div className="flex items-center justify-center pt-1">
                <Button
                  onClick={() => onNavigate("benchmark")}
                  className="btn-brand-glow text-white shadow-md shadow-[#853953]/30 dark:shadow-[#D84577]/35 h-11 px-7 rounded-xl text-xs sm:text-sm font-semibold flex items-center gap-2.5 cursor-pointer group"
                >
                  <Icons.Play className="h-4 w-4" />
                  <span>Open Studio</span>
                  <Icons.ArrowRight className="h-4 w-4 opacity-75 group-hover:translate-x-1 transition-transform" />
